# 自动扫描原始 Test 数据集文件夹，生成标准 CSV + label_map + manifest 的数据索引构建脚本。
...
def main():
    ...
    manifest_path = OUT_DIR / "test_manifest_23.json"
    label_map_path = OUT_DIR / "label_map_23.json"
    csv_path = OUT_DIR / "test_index_23.csv"
